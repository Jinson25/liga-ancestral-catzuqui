...
export default async function Home() {
  ...
  // Transformar datos para cumplir con el tipo esperado y validar URLs
  const equipos: Equipo[] = equiposData?.map(equipo => {
    // Validar y formatear la URL del logo
    let logoUrl = 'https://www.atlantiasearch.com/images/ProductImages/SI_PRUEBA_PDV.jpg'; // URL por defecto
    if (equipo.logo) {
      try {
