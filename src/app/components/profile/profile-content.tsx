...
export function ProfileContent() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-teal-50 to-blue-50 pt-5 z-0">
                    ...
                    <div className="relative px-8 -mt-16">
                        <div className="flex flex-col sm:flex-row items-center">
                            ...
                            <div className="mt-6 sm:mt-0 sm:ml-6 text-center sm:text-left">
                                ...
                                <p className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800 mt-2 ">{profile.correo}</p>
